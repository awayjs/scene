...
var Merge = (function () {
    ...
    Merge.prototype.merge = function (destSprite, dispose) {
        ...
        for (i = 0; i < this._shapeVOs.length; i++) {
            var elements = new graphics_1.TriangleElements(new core_1.AttributesBuffer());
            ...
            if (this._keepMaterial && useSubMaterials)
                destGraphics.addShape(graphics_1.Shape.getShape(elements, data.material));
            else
                destGraphics.addShape(graphics_1.Shape.getShape(elements));
        }
