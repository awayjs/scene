...
var DisplayObjectContainer = (function (_super) {
    ...
    DisplayObjectContainer.prototype.dispatchFrameEvents = function (events) {
    ...
    DisplayObjectContainer.prototype.addChildAtDepth = function (child, depth, replace) {
        ...
        if (child == null)
            throw new core_1.ArgumentError("Parameter child cannot be null.");
    ...
    DisplayObjectContainer.prototype.getChildAt = function (index) {
        ...
        if (child == null)
            throw new core_1.RangeError("Index does not exist in the child list of the caller");
        return child;
    };
    /**
    ...
    DisplayObjectContainer.prototype.getChildIndex = function (child) {
        ...
        if (childIndex == -1)
            throw new core_1.ArgumentError("Child parameter is not a child of the caller");
        return childIndex;
    };
    ...
    DisplayObjectContainer.prototype.removeChildren = function (beginIndex, endIndex) {
        ...
        if (beginIndex < 0)
            throw new core_1.RangeError("beginIndex is out of range of the child list");
        if (endIndex > this._children.length)
            throw new core_1.RangeError("endIndex is out of range of the child list");
