 ...
 *                                  options
 */
export declare class TextFieldMultiRender extends Sprite {
    private static _textFields;
    static assetType: string;
    private _explicitFormats;
    private _explicitFormatsRanges;
    private _line_indices;
    ...
    private setFormatForRange(start, end, format);
    private getFormatAtChar(char_pos);
    /**
     ...
     * selection mode.
     */
    readonly textInteractionMode: TextInteractionMode;
    /**
     ...
     */
    reConstruct(useCanvas2dhack?: boolean): void;
    /**
    ...
    clone(): TextFieldMultiRender;
    copyTo(newInstance: TextFieldMultiRender): void;
}
