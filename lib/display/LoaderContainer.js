...
var LoaderContainer = (function (_super) {
    ...
    LoaderContainer.prototype.close = function () {
        ...
        if (this._useAssetLib) {
            var lib;
            lib = core_1.AssetLibraryBundle.getInstance(this._assetLibId);
    ...
    LoaderContainer.prototype._getLoader = function () {
        if (this._useAssetLib) {
            var lib = core_1.AssetLibraryBundle.getInstance(this._assetLibId);
            this._loader = lib.getLoader();
        }
        else {
            this._loader = new core_1.Loader();
        }
        this._loader.addEventListener(core_1.LoaderEvent.LOAD_COMPLETE, this._onLoadCompleteDelegate);
        this._loader.addEventListener(core_1.AssetEvent.TEXTURE_SIZE_ERROR, this._onTextureSizeErrorDelegate);
        this._loader.addEventListener(core_1.AssetEvent.ASSET_COMPLETE, this._onAssetCompleteDelegate);
    ...
    LoaderContainer.prototype._disposeLoader = function () {
        this._loader.removeEventListener(core_1.LoaderEvent.LOAD_COMPLETE, this._onLoadCompleteDelegate);
        this._loader.removeEventListener(core_1.AssetEvent.TEXTURE_SIZE_ERROR, this._onTextureSizeErrorDelegate);
        this._loader.removeEventListener(core_1.AssetEvent.ASSET_COMPLETE, this._onAssetCompleteDelegate);
        if (!this._useAssetLib)
            this._loader.stop();
        this._loader = null;
    };
    ...
    LoaderContainer.enableParser = function (parserClass) {
        core_1.Loader.enableParser(parserClass);
    };
    /**
    ...
    LoaderContainer.enableParsers = function (parserClasses) {
        core_1.Loader.enableParsers(parserClasses);
    };
    ...
    LoaderContainer.prototype.onLoadError = function (event) {
        if (this.hasEventListener(core_1.URLLoaderEvent.LOAD_ERROR)) {
            this.dispatchEvent(event);
            return true;
        }
        else {
    ...
    LoaderContainer.prototype.onParseError = function (event) {
        if (this.hasEventListener(core_1.ParserEvent.PARSE_ERROR)) {
            this.dispatchEvent(event);
            return true;
        }
        else {
