...
var Cast = (function () {
    ...
    Cast.byteArray = function (data) {
        if (typeof (data) == 'function')
            data = new data;
        if (data instanceof core_1.ByteArray)
            return data;
        return data;
    };
    ...
    Cast.image2D = function (data) {
        ...
        if (data instanceof graphics_1.Image2D)
            return data;
        if (data instanceof graphics_1.Single2DTexture)
            data = data.image2D;
    ...
    Cast.bitmapTexture = function (data) {
        ...
        try {
            ...
            return new graphics_1.Single2DTexture(bmd);
        }
        catch (e /*CastError*/) {
        }
