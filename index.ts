...
export {TextureProjector}			from "./lib/display/TextureProjector";
...
export {CascadeShadowMapper}				from "./lib/shadowmappers/CascadeShadowMapper";
export {CubeMapShadowMapper}				from "./lib/shadowmappers/CubeMapShadowMapper";
export {DirectionalShadowMapper}			from "./lib/shadowmappers/DirectionalShadowMapper";
export {NearDirectionalShadowMapper}		from "./lib/shadowmappers/NearDirectionalShadowMapper";
export {ShadowMapperBase}				from "./lib/shadowmappers/ShadowMapperBase";
